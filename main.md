...
## 1. 概要
- **対象のデータ**：心理的ストレスを与えるため7日間拘束したマウスにおける結腸全組織のバルク RNA-seq データ、Control 群と Stress 群それぞれ各 n=5 ([Schneider, Kai Markus et al. Cell, Volume 186, Issue 13, 2823-2838.e20])(https://doi.org/10.1016/j.cell.2023.05.001)
